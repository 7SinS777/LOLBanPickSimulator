...
<div style="text-align: center;">
	<div class="lane-group">
		<div class="lane-margin">
			<select name="redTOP" class="player" id="redTOP">
	...
	<div class="lane-group">
		<div class="lane-margin">
			<select name="redJGL" class="player" id="redJGL">
	...
	<div class="lane-group">
		<div class="lane-margin">
			<select name="redMID" class="player" id="redMID">
	...
	<div class="lane-group">
		<div class="lane-margin">
			<select name="redADC" class="player" id="redADC">
	...
	<div class="lane-group">
		<div class="lane-margin">
			<select name="redSPT" class="player" id="redSPT">
